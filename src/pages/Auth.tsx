    ...
    <div className="min-h-screen bg-gradient-soft flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-1">AI-powered face analysis</p>
        </div>
        ...
        <motion.button
          ...
          disabled={loading}
          className="w-full py-3.5 rounded-2xl bg-card border border-border text-foreground font-medium text-sm flex items-center justify-center gap-3 shadow-card mb-5"
          whileTap={{ scale: 0.98 }}
        >
