...
export const hairstyles: HairStyle[] = [
  { id: "h1", name: "Textured Crop", faceShapes: ["Oval", "Square", "Heart"], hairType: "Straight", length: "Short", trending: true, emoji: "✂️",
  ...
  { id: "h2", name: "Classic Fade", faceShapes: ["Oval", "Round", "Square"], hairType: "Straight", length: "Short", trending: true, emoji: "💈",
  ...
  { id: "h3", name: "Quiff", faceShapes: ["Oval", "Heart", "Diamond"], hairType: "Straight", length: "Medium", trending: true, emoji: "🌊",
  ...
  { id: "h4", name: "Buzz Cut", faceShapes: ["Oval", "Square", "Diamond"], hairType: "Straight", length: "Short", trending: false, emoji: "⚡",
  ...
  { id: "h5", name: "Pompadour", faceShapes: ["Oval", "Square", "Oblong"], hairType: "Straight", length: "Medium", trending: true, emoji: "👑",
  ...
  { id: "h6", name: "Curly Fringe", faceShapes: ["Oval", "Heart", "Diamond"], hairType: "Curly", length: "Medium", trending: true, emoji: "🌀",
  ...
  { id: "h7", name: "Slick Back", faceShapes: ["Oval", "Square", "Heart"], hairType: "Straight", length: "Medium", trending: false, emoji: "🪮",
  ...
  { id: "h8", name: "Messy Medium", faceShapes: ["Oval", "Round", "Heart"], hairType: "Wavy", length: "Medium", trending: true, emoji: "🌿",
  ...
  { id: "h9", name: "Undercut", faceShapes: ["Oval", "Square", "Diamond"], hairType: "Straight", length: "Short", trending: true, emoji: "⚔️",
  ...
  { id: "h10", name: "Afro Fade", faceShapes: ["Round", "Oval", "Square"], hairType: "Coily", length: "Short", trending: true, emoji: "✊",
  ...
  { id: "h11", name: "Man Bun", faceShapes: ["Oval", "Oblong", "Square"], hairType: "Straight", length: "Long", trending: false, emoji: "🔝",
  ...
  { id: "h12", name: "French Crop", faceShapes: ["Oval", "Square", "Round"], hairType: "Straight", length: "Short", trending: true, emoji: "🇫🇷",
  ...
  { id: "h13", name: "Taper Fade with Beard", faceShapes: ["Oval", "Round", "Heart"], hairType: "Straight", length: "Short", trending: true, emoji: "🧔",
  ...
  { id: "h14", name: "Curtains / eBoy", faceShapes: ["Oval", "Heart", "Diamond"], hairType: "Straight", length: "Medium", trending: true, emoji: "🎭",
  ...
  { id: "h15", name: "Crew Cut", faceShapes: ["Oval", "Square", "Oblong"], hairType: "Straight", length: "Short", trending: false, emoji: "🎖️",
